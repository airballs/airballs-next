        ...
        <div className={klass}>
          <div className="cookies-box `#{klass}`">
            <div className="cookies-row">
              <p className="font-s text-center gray-500-cl">{message}</p>
              <p className="font-s text-center gray-500-cl">For more information you can visit our <a href="/legal" rel="noreferrer">Policies & Terms</a> section.</p>
            </div>
            <div className="cookies-row">
